export default function RegisterPage() {
  return (
    <main className="mx-auto flex max-w-md flex-col px-6 py-20">
      ...
      <h1 className="mt-4 text-3xl font-medium text-paper">Crear cuenta</h1>
      <form className="mt-8 space-y-4">
        <label className="block text-sm text-mute">
          Nombre de usuario
          <input type="text" required className="mt-2 w-full rounded-sm border border-line bg-panel px-4 py-3 text-paper" />
        </label>
        <label className="block text-sm text-mute">
          Email
